...
import (
	...
	"github.com/khulnasoft-lab/cloud-scanner/service"
...
var (
	...
	rolePrefix            = flag.String("role-prefix", "khulnasoft-cloud-scanner", "Prefix for role to be assumed in monitored accounts")
...
func runServices(config util.Config, socketPath *string) {
	...
	log.Info().Msgf("Registering with Khulnasoft management console")
...
func main() {
	...
	if *successSignalUrl != "" {
		khulnasoft.SendSuccessfulDeploymentSignal(*successSignalUrl)
	}
