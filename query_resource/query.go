...
func QueryAndRegisterResources(config util.Config, client *khulnasoft.Client) []error {
...
func QueryAndUpdateResources(config util.Config, client *khulnasoft.Client, cloudResourceTypesToRefresh map[string][]string) []error {
